...
def api_func(
    ...
    data_over_time_sentences = f"""
            From the start of 2014 through the end of 2018, Philadelphia police made an average of <span>{value_2014_to_2018:,}</span> {police_action.noun} per month in {geo_level_str}.

            During a surge in stops in 2019, Philadelphia police made an average of <span>{value_2019_surge:,}</span> traffic stops per month in {geo_level_str}.

            From the start of April 2020 through the end of March 2021 (pandemic), Philadelphia police made an average of <span>{value_covid:,}</span> {police_action.noun} per month in {geo_level_str}.
        """
